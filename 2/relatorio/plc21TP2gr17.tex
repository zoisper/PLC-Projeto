...
Também gostariamos que nossa linguagem fosse possível escrever condições lógicas com parentises para alterar a precedencia. Tal seria possível, no anexo A do documento temos comentada a produção seguinte:
\begin{verbatim}
